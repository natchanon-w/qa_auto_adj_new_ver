...
var sqlColumns = []string{
	"id", "ref_id", "original_ref_id", "req_channel", "requester", "req_dtm", "ref_no", "payment_txn_ref",
	"tfr_dtm", "created_request_id", "amount", "denomination", "customer_note", "customer_ref_id",
	"from_main_account_id", "from_main_account_no", "from_transfer_account_no", "from_acct_no", "from_acct_id",
	"to_internal_acct_id", "from_trans_code", "from_address", "from_acct_status", "from_product_class",
	"from_product_group", "from_product_type", "from_acct_type", "from_branch_code", "from_account_display_name",
	"from_account_name_th", "from_account_name_en", "from_bank_code", "from_core_bank_channel", "from_cif_no",
	"from_cdi_token", "from_internal_acct_id", "to_main_account_id", "to_main_account_no", "to_transfer_account_no",
	"to_acct_no", "to_acct_id", "to_trans_code", "to_address", "to_acct_status", "to_product_class",
	"to_product_group", "to_product_type", "to_acct_type", "to_branch_code", "to_account_display_name",
	"to_account_name_th", "to_account_name_en", "to_bank_code", "to_core_bank_channel", "to_cif_no",
	"to_cdi_token", "fee_amount", "fee_internal_acct_id", "fee_trans_code", "fee_type", "status",
	"status_code", "status_desc", "debit_status", "credit_status", "service_type", "created_dtm",
	"updated_dtm", "transaction_type", "posting_type", "effective_date", "reversal_flag", "transfer_type",
	"input_terminal", "dcb_request", "dcb_response",
}
