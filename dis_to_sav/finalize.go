...
func cmdFinalize(args []string) {
	...
	controlFilename := fmt.Sprintf("reconcile-lending-disburse_to_saving-%s.json", uuidv4.String())
	...
	// SQL
	const tableName = "disbursement_transactions"
	const batchSize = 500
