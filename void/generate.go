...
var csvHeader = []string{
	...
	"dlp_event_dtm", "dlp_from_loan_acct_no", "dlp_from_loan_acct_id", "dlp_txn_status", "dlp_txn_amt",
	"dlp_acct_status", "dlp_product_flow_type", "dpp_effective_date", "dpp_event_dtm", "dpp_from_loan_acct_no",
	"dpp_from_loan_acct_id", "dpp_txn_status", "dpp_txn_amt", "dpp_cust_fee", "dpp_dcb_status",
...
func cmdGenerate(args []string) {
	...
	for t := 0; t < times; t++ {
		...
		csvRowMap := map[string]string{
			...
			"dpp_from_loan_acct_id":   newUUIDv7(),
