...
var typeDefs = map[string]TypeDef{
	"outbound_promptpay": {
		...
		Template: map[string]interface{}{
			...
			"from_account_type": "POCKET", "from_account_display_name": "", "from_account_name_th": "",
			"from_account_name_en": "", "type_of_sender": "H", "sender_tax_id": "",
			"to_any_id": nil, "to_any_id_type": "EWALLETID", "to_bank_code": "008",
			"to_account_no": nil, "to_account_name": "", "to_account_display_name": "",
	...
	"outbound_actual_account": {
		...
		Template: map[string]interface{}{
			...
			"from_account_type": "POCKET", "from_account_display_name": "", "from_account_name_th": "",
			"from_account_name_en": "", "type_of_sender": "H", "sender_tax_id": "",
			"to_bank_code": "034", "to_account_no": nil, "to_account_name": "",
			"to_account_display_name": "", "type_of_receiver": "H", "receiver_tax_id": "",
	...
	"inbound_promptpay": {
		...
		Template: map[string]interface{}{
			...
			"ctfi_from_acct_id": nil, "ctfi_from_acct_bank_code": "014", "ctfi_from_acct_name": "",
			"ctfi_from_display_name": "", "ctfi_to_any_id": nil, "ctfi_to_any_type": "EWALLETID",
			"ctfi_to_acct_id": nil, "ctfi_to_acct_status": "0", "ctfi_to_acct_name": "",
			"ctfi_to_display_name": "", "ctfi_tfr_amt": "0.01", "ctfi_tfr_ref_no": nil,
	...
	"inbound_actual_account": {
		...
		Template: map[string]interface{}{
			...
			"acti_from_acct_id": nil, "acti_from_acct_bank_code": "025", "acti_from_acct_name": "",
			"acti_from_display_name": "", "acti_to_acct_id": nil, "acti_to_acct_status": "0",
			"acti_to_acct_name": "", "acti_to_display_name": "", "acti_tfr_amt": "10.01",
