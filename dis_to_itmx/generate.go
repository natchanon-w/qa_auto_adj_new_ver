...
var csvHeader = []string{
	...
	"dlp_txn_status", "dlp_txn_amt", "dlp_acct_status", "dlp_product_flow_type", "dpp_effective_date",
	"dpp_event_dtm", "dpp_from_loan_acct_no", "dpp_from_loan_acct_id", "dpp_txn_status", "dpp_itmx_txn_status",
	"dpp_txn_amt", "dpp_cust_fee", "dpp_dcb_status", "dpp_dlp_status", "dpp_biller_id", "dpp_payment_ref1",
	"dpp_payment_ref2", "dpp_payment_ref3", "dpp_payment_ref4", "dpp_posting_type", "dcb_effective_date",
	"dcb_event_dtm", "dcb_from_loan_acct_id", "dcb_txn_status", "dcb_txn_amt", "dcb_cust_fee",
	"dcb_acct_status", "dcb_posting_type",
}

var cases = []map[string]map[string]string{
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "SUCCESS", "dcb_txn_status": "SUCCESS", "dpp_txn_status": "PRCS"}, "sql": {"status": "PROCESSING", "dcb_status": "", "dlp_status": ""}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "FAILED", "dcb_txn_status": "REVERSED", "dpp_txn_status": "DISB_REV_CLO_REV_FAILED"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_FAILED"}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "FAILED", "dcb_txn_status": "REVERSED", "dpp_txn_status": "DISB_REV_CLO_REV_TIMEOUT"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_TIMEOUT"}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "FAILED", "dpp_txn_status": "DISB_REV_FAILED"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": ""}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "FAILED", "dpp_txn_status": "DISB_REV_TIMEOUT"}, "sql": {"status": "FAILED", "dcb_status": "REVERSED_TIMEOUT", "dlp_status": ""}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "REVERSED", "dpp_txn_status": "DISB_REV_CLO_REV_FAILED"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_FAILED"}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "REVERSED", "dpp_txn_status": "DISB_REV_CLO_REV_TIMEOUT"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_TIMEOUT"}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "REVERSED", "dpp_txn_status": "DISB_REV_TIMEOUT"}, "sql": {"status": "FAILED", "dcb_status": "REVERSED_TIMEOUT", "dlp_status": ""}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "FAILED", "dpp_txn_status": "CLO_REV_FAILED"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_FAILED"}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "FAILED", "dpp_txn_status": "CLO_REV_TIMEOUT"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_TIMEOUT"}},
	{"csv": {"auto_adj_txn_status": `["DLP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "FAILED", "dpp_txn_status": "CLO_REV_TIMEOUT"}, "sql": {"status": "FAILED", "dcb_status": "", "dlp_status": "REVERSED_TIMEOUT"}},
	{"csv": {"auto_adj_txn_status": `["DPP"]`, "dpp_itmx_txn_status": "", "dcb_txn_status": "FAILED", "dpp_txn_status": "PRCS"}, "sql": {"status": "PROCESSING", "dcb_status": "", "dlp_status": ""}},
}
...
var recTemplate = map[string]string{
	...
	"dcb_event_dtm":           "2025-01-01 15:14",
...
func cmdGenerate(args []string) {
	...
	csvFilename := fmt.Sprintf("DISBURSE_TO_ITMX_BILLERS_RECONCILE_UNMATCHED_%s.csv", csvDate.Format("20060102"))
